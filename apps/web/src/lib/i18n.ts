...
export const t = {
  ...
  nav: {
    ...
    signup: { vi: "Dùng Cloud miễn phí", en: "Start free on Cloud" },
  ...
  auth: {
    title: { vi: "Đăng nhập Vết Cloud", en: "Sign in to Vết Cloud" },
    demoHint: { vi: "Demo: demo@vet.dev / demo", en: "Demo: demo@vet.dev / demo" },
    ...
    noOrg: { vi: "Chưa có org?", en: "No org yet?" },
  },
  signup: {
