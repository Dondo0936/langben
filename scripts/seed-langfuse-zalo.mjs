 ...
 * Requires the console on :3000 (docker compose) with INIT keys from .env.console.example.
 *
...
const t0 = "2026-09-09T14:02:01.000Z";
...
const batch = [
  ...
  ev("span-create", t0, {
    ...
    name: "zalo.inbound",
    startTime: t0,
    endTime: "2026-09-09T14:02:01.120Z",
    input: { event: "user_send_text", text: "hủy đơn" },
    output: { msg_id: "m_1001", user_id: "user_847712" },
    metadata: { vet_type: "channel.inbound", channel: "zalo_oa" },
  }),
  ev("span-create", "2026-09-09T14:02:01.200Z", {
    id: "obs_nlu_1",
    traceId,
    parentObservationId: "obs_in_1",
    name: "fpt.nlu",
    startTime: "2026-09-09T14:02:01.200Z",
    endTime: "2026-09-09T14:02:01.540Z",
    input: { text: "hủy đơn" },
    output: { intent: "cancel_order", confidence: 0.93 },
    metadata: { vet_type: "nlu", route: "fpt-conversation" },
  }),
  ev("generation-create", "2026-09-09T14:02:01.600Z", {
    id: "obs_gen_1",
    traceId,
    parentObservationId: "obs_nlu_1",
    name: "anthropic.messages.create",
    startTime: "2026-09-09T14:02:01.600Z",
    endTime: "2026-09-09T14:02:03.100Z",
  ...
  ev("span-create", "2026-09-09T14:03:07.800Z", {
    id: "obs_out_1",
    traceId,
    parentObservationId: "obs_gen_1",
    name: "zalo.outbound",
    startTime: "2026-09-09T14:03:07.800Z",
...
console.log(`Seeded ${traceId} → ${base}/project/prj-vet-demo/traces`);
console.log(`Session ${sessionId} → ${base}/project/prj-vet-demo/sessions`);
