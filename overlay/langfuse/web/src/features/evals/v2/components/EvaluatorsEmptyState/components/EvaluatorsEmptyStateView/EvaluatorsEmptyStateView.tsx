  ...
  return (
    <EvaluatorRecommendedCardSurface>
      <button
        ...
        aria-label={`Thiết lập ${startingPoint.title}`}
    ...
    >
      <EvaluatorRecommendedCardSurface>
        <EvaluatorRecommendedCardContent
          ...
          title="Xem mọi mẫu"
          description="Tìm theo thứ cần đo — chất lượng, retrieval, an toàn, phân loại, coding agent."
        />
      </EvaluatorRecommendedCardSurface>
    </button>
  );
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col items-center px-8 pt-24 pb-8">
      <div className="mb-6 max-w-2xl text-center">
        <h2 className="mb-2 text-2xl font-bold">
          Chấm vết thành tín hiệu chất lượng
        </h2>
        <p className="text-muted-foreground text-base">
          Bộ đánh giá chấm dữ liệu bằng LLM-as-a-judge hoặc bằng code. Chạy trên
          vết production để thấy mẫu, hoặc trên dataset trước khi ship.{" "}
          <a
            href={docsHref}
            target="_blank"
          ...
          >
            Cách dùng bộ đánh giá.
          </a>
        </p>
      </div>

      <div className="w-full">
        <EvaluatorRecommendedCards label="Điểm bắt đầu">
