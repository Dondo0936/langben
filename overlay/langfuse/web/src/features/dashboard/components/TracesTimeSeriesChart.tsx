...
export const TracesAndObservationsTimeSeriesChart = ({
    ...
    () =>
      traces.data
        ? traces.data.map((item) => ({
            ...
            values: [{ label: "Vết", value: Number(item.count_count) }],
          }))
        : [],
    [traces.data],
  );
  ...
  const data = isV2
    ? [
        {
          tabTitle: "Quan sát theo mức",
          data: transformedObservations,
          totalMetric: totalObservations,
          metricDescription: `Quan sát đã ghi`,
          chartMetricLabel: "Quan sát",
        },
      ]
    : [
        {
          ...
          totalMetric: total,
          metricDescription: `Vết đã ghi`,
          chartMetricLabel: "Vết",
        },
        {
          tabTitle: "Quan sát theo mức",
          data: transformedObservations,
  ...
  return (
    <DashboardCard
      className={className}
      title={isV2 ? "Quan sát theo thời gian" : "Vết theo thời gian"}
      isLoading={
