...
export const UserChart = ({
  ...
  const transformedCost: BarChartDataPoint[] = user.data
    ? user.data
        ...
        .map((item) => {
          return {
            name: (item.userId as string | null | undefined) ?? "Không rõ",
