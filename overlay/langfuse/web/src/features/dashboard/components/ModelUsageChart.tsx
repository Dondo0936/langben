...
export const ModelUsageChart = ({
  ...
  const data = [
    {
      tabTitle: "Chi phí theo model",
      data: costByModel,
      totalMetric: costFormatter(totalCost),
      metricDescription: "Chi phí",
      chartMetricLabel: "USD",
      chartUnit: "USD",
    },
    {
      tabTitle: "Chi phí theo loại",
      data: costByType,
      totalMetric: costFormatter(totalCost),
      metricDescription: "Chi phí",
      chartMetricLabel: "USD",
    ...
    {
      tabTitle: "Mức dùng theo model",
      data: unitsByModel,
      totalMetric: totalTokens
        ? compactNumberFormatter(totalTokens)
        : compactNumberFormatter(0),
      metricDescription: "Đơn vị",
      chartMetricLabel: "Token",
      chartUnit: "token",
    },
    {
      tabTitle: "Mức dùng theo loại",
      data: unitsByType,
      totalMetric: totalTokens
        ? compactNumberFormatter(totalTokens)
        : compactNumberFormatter(0),
