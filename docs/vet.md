...
4. Tab **Scores** trên observation hoặc trên root trace — score gắn vào bước đó.
5. Metadata `sessionId` đưa bạn sang [Phiên](phien.md) cùng hội thoại.

Seed demo: `node scripts/seed-langfuse-zalo.mjs` rồi mở `tr_zalo_huy_don`.
...
- [Scores](scores.md) — chấm lượt sau khi xem cây
