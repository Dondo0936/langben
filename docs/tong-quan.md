...
Trang chủ project: số vết đã ghi, chi phí model, điểm, và biểu đồ theo thời gian.

Mở khi bạn muốn biết project đang sống — có ingest không, model nào tốn token, điểm nào đã gắn — trước khi soi một lượt cụ thể.
...
4. Thẻ **Điểm** đếm score đã ingest (ví dụ `# helpful`).
